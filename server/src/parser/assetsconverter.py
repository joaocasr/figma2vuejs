...
def convertToDropdown(data,nr_columnstart,nr_columnend,nr_rowstart,nr_rowend,id,name):
    ...
    try:
        ...
        style = DropdownStyle("rgba(0,0,0,1)","rgba(0,0,0,1)","rgba(0,0,0,1)","rgba(0,0,0,1)","rgba(0,0,0,1)","rgba(0,0,0,1)","rgba(0,0,0,1)",borderRadius,nr_columnstart,nr_columnend,nr_rowstart,nr_rowend)
        style.setHeight(elementheight)
        style.setWidth(elementwidth)
        style.setX(xielem)
        style.setY(yielem)
        melement = Dropdown(id,"",name,"COMPONENT_ASSET","selectedOption"+getElemId(id),[],placeholder,False,style)
        return melement
...
def convertToSearchInput(data,nr_columnstart,nr_columnend,nr_rowstart,nr_rowend,id,name):
    ...
    try:
        ...
        style = InputSearchStyle(backgroundcolor,txtcolor,radius,nr_columnstart,nr_columnend,nr_rowstart,nr_rowend)
        style.setHeight(elementheight)
        style.setWidth(elementwidth)
        style.setX(xielem)
        style.setY(yielem)
        ...
        style = InputSearchStyle("rgba(0,0,0,1)","rgba(255,255,255,1)","0",nr_columnstart,nr_columnend,nr_rowstart,nr_rowend)
        style.setHeight(elementheight)
        style.setWidth(elementwidth)
        style.setX(xielem)
        style.setY(yielem)
...
def convertToDatePicker(data,nr_columnstart,nr_columnend,nr_rowstart,nr_rowend,id,name):
    ...
    try:
        ...
        style = DatePickerStyle("rgba(255,255,255,1)","rgba(255,255,255,1)","rgba(0,0,0,1)",nr_columnstart,nr_columnend,nr_rowstart,nr_rowend)
        style.setHeight(elementheight)
        style.setWidth(elementwidth)
        style.setX(xielem)
        style.setY(yielem)
...
def convertToSlider(data,percentage,nr_columnstart,nr_columnend,nr_rowstart,nr_rowend,id,name):
    ...
    try:
        ...
        style = SliderStyle("rgba(255,255,255,1)","rgba(255,255,255,1)","rgba(0,0,0,1)","rgba(0,0,0,1)",nr_columnstart,nr_columnend,nr_rowstart,nr_rowend)
        style.setHeight(elementheight)
        style.setWidth(elementwidth)
        style.setX(xielem)
        style.setY(yielem)
...
def convertToRating(data,nr_columnstart,nr_columnend,nr_rowstart,nr_rowend,id,name,readOnly):
    ...
    try:
        ...
        style = RatingStyle("rgba(255,255,255,255)","rgba(0,0,0,1)",nr_columnstart,nr_columnend,nr_rowstart,nr_rowend)
        style.setHeight(elementheight)
        style.setWidth(elementwidth)
        style.setX(xielem)
        style.setY(yielem)
...
def convertToPaginator(data,nr_columnstart,nr_columnend,nr_rowstart,nr_rowend,id,name):
    ...
    try:
        ...
        style = PaginatorStyle("0","","rgba(0,0,0,1)","rgba(255,255,255,1)",nr_columnstart,nr_columnend,nr_rowstart,nr_rowend)
        style.setHeight(elementheight)
        style.setWidth(elementwidth)
        style.setX(xielem)
        style.setY(yielem)
...
def convertToCheckbox(data,nr_columnstart,nr_columnend,nr_rowstart,nr_rowend,id,name):
    ...
    try:
        ...
        style = CheckboxStyle("rgba(0,0,0,1)","rgba(255,255,255,1)",boxRadius, nr_columnstart,nr_columnend,nr_rowstart,nr_rowend)
        style.setHeight(elementheight)
        style.setWidth(elementwidth)
        style.setX(xielem)
        style.setY(yielem)
...
def convertToMenu(data,nr_columnstart,nr_columnend,nr_rowstart,nr_rowend,id,name):
    ...
    try:
        ...
        style.setX(xielem)
        style.setY(yielem)
        menu = Menu(id,"",menuName,"COMPONENT_ASSET",options,None,style)
        return menu
...
def convertToTable(data,nr_columnstart,nr_columnend,nr_rowstart,nr_rowend,id,name):
    ...
    try:
        ...
        style = TableStyle("rgba(255,255,255,1)","rgba(255,255,255,1)","rgba(0,0,0,1)","rgba(255,255,255,1)",nr_columnstart,nr_columnend,nr_rowstart,nr_rowend)
        style.setHeight(elementheight)
        style.setWidth(elementwidth)
        style.setX(xielem)
        style.setY(yielem)
